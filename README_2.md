...
I'm an AI/ML Engineer focused on **Data Analysis, Machine Learning, Generative AI, and Retrieval-Augmented Generation (RAG)**, with a growing background in IoT. I completed an internship at **CyanConnode Pvt. Limited**, where I worked on real-world applications combining LLMs, RAG pipelines, and IoT data. I enjoy the full pipeline — from cleaning and analyzing data, to building ML models, to wiring up LLM-powered agents on top of it — and I'm actively looking for opportunities to apply and grow these skills further.
...
const pratyush = {
  ...
  currentStack: [
    ...
    "Agentic AI", "Data Visualization", "Git & GitHub"
  ],
  certifications: [
